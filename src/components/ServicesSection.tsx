...
import { Mountain, Flame, Wifi, ChefHat, Home, ShowerHead, Tv, Wine, Lock, Bed, Bath, Sofa, Trees } from 'lucide-react'
		...
		<section id="services" ref={sectionRef} className="py-20 bg-background">
			<div className="container mx-auto px-6 max-w-6xl">
				<div className="text-center mb-16">
					<span className="text-accent text-sm uppercase tracking-wider font-semibold">Noclegi & Pakiety</span>
					<h2 className="mt-4 mb-6 text-4xl md:text-5xl font-bold text-foreground">Wybierz Swój Pobyt</h2>
					<p className="text-muted-foreground text-lg max-w-2xl mx-auto">
						Od romantycznych pokoi po całe domki i specjalne pakiety – każda opcja zapewnia komfort, autentyczność i
						bliskość natury.
					</p>
				</div>
							...
							<div
								...
								<div className={`${isReverse ? 'lg:order-1' : 'lg:order-2'}`}>
									<div className="flex gap-3 mb-4">
										<span className="border border-gray-300 text-gray-600 px-3 py-1 text-sm">{service.size}</span>
										<span className="border border-gray-300 text-gray-600 px-3 py-1 text-sm">{service.guests}</span>
									</div>
