...
const StorySection = () => {
	...
	return (
		<section id="story" ref={sectionRef} className="py-32 bg-white transition-colors duration-1000">
			<div className="container mx-auto px-6">
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
					...
					<div className="lg:sticky lg:top-10">
						...
						<h2 ref={titleRef} className="mb-8 text-4xl md:text-5xl lg:text-6xl font-bold text-black">
							Gdzie Tradycja Spotyka się z Naturą
						</h2>

						<div ref={textRef} className="space-y-6 text-gray-800 text-lg leading-relaxed">
							<p>
								Sielska Ostoja to nie tylko miejsce na mapie Beskidu Małego. To rodzinna pasja, która narodziła się
								ponad 30 lat temu, gdy nasi dziadkowie postanowili przekształcić tradycyjne gospodarstwo w refugium dla
								zmęczonych miejskim zgiełkiem dusz.
							</p>

							<p>
								Położone w malowniczej wiosce Górska Wieś, nasze ranczo rozciąga się na 20 hektarach naturalnych łąk,
								lasów i pól. Każdego ranka budzimy się z widokiem na szczyty górskie spowijane poranną mgłą, a powietrze
								wypełnia zapach świeżo skoszonej trawy i dzikiego tymianku.
							</p>

							<p>
								Dziś, prowadzone przez trzecie pokolenie, Sielska Ostoja łączy w sobie szacunek do tradycji z
								nowoczesnymi standardami komfortu. Nasze konie to nie tylko atrakcja – to członkowie rodziny, każdy z
								własnym charakterem i historią. Warsztaty serowarskie prowadzi pani Helena, która od 40 lat tworzy ser
								podhalański metodami przekazywanymi z pokolenia na pokolenie.
							</p>

							<p>
								Wierzymy w filozofię Slow Life – życia w harmonii z rytmem natury, bez pośpiechu, za to z pełną
								świadomością każdej chwili. To miejsce, gdzie czas płynie wolniej, a priorytety układają się na nowo.
							</p>
						</div>
					</div>
