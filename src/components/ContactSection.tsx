		...
		<section id="contact" ref={sectionRef} className="relative py-32 bg-background overflow-hidden">
			...
			<div className="absolute inset-0 opacity-5 pointer-events-none">
				<svg className="w-full h-full" viewBox="0 0 1000 1000">
					...
					/>
					<path
						d="M 500 100 Q 600 200 500 300 Q 400 400 500 500"
			...
			<div className="container mx-auto px-6 relative z-10">
				<div className="text-center mb-16">
					<span className="text-secondary text-sm uppercase tracking-wider font-semibold">Skontaktuj się</span>
					<h2 className="mt-4 mb-6">Zarezerwuj Swój Pobyt Już Dziś</h2>
					<p className="text-muted-foreground text-lg max-w-2xl mx-auto">
						Masz pytania? Chcesz zarezerwować pobyt? Napisz lub zadzwoń. Odpowiadamy w ciągu 2 godzin.
					</p>
				</div>
				...
				<div
					...
					<div className="space-y-8">
								...
								<div className="flex items-start gap-4">
									...
									<div>
										...
										<p className="text-muted-foreground">
											Sielska Ostoja
											<br />
											ul. Zielona Dolina 15
											<br />
											32-450 Górska Wieś, Polska
										</p>
									</div>
								</div>
						...
						{/* Google Maps */}
						<div className="h-64 lg:h-80 shadow-[var(--shadow-medium)] rounded-lg overflow-hidden relative bg-muted">
							<iframe
								src="https://maps.google.com/maps?q=49.7234567,19.4567891&hl=pl&z=14&output=embed"
								width="100%"
								height="100%"
								style={{ border: 0 }}
								allowFullScreen
								...
								title="Mapa lokalizacji Sielska Ostoja - Górska Wieś"
							...
							<div className="absolute inset-0 flex items-center justify-center text-muted-foreground bg-muted -z-10">
								<div className="text-center">
									...
									<p>Ładowanie mapy...</p>
									<p className="text-sm">Górska Wieś, Beskid Mały</p>
								</div>
							</div>
						</div>
					</div>
