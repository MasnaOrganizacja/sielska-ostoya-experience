    ...
    >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20 pt-10">
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-50 items-center top-24 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white flex items-center justify-center shadow-lg">
                <div className="h-4 w-4 rounded-full bg-orange-500 border-2 border-orange-600" />
              </div>
        ...
        <div
          ...
          className="absolute md:left-8 left-8 top-10 overflow-hidden w-[2px] bg-gradient-to-b from-transparent via-orange-300 to-transparent"
        >
          <div
            style={{
              height: "100%",
            }}
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-b from-orange-500 via-orange-400 to-orange-300 rounded-full"
          />
        </div>
      </div>
    </div>
