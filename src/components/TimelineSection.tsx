  ...
  const data = [
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-sm font-normal text-stone-300 md:text-base">
            Ciepłe powitanie przez gospodarzy, prezentacja terenu rancza i
            wprowadzenie do atmosfery beskidzkiego życia. Otrzymasz mapę okolicy
            i plan aktywności.
          </p>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-sm font-normal text-stone-300 md:text-base">
            Pierwsza wizyta w stajni i poznanie naszych koni, osiołków, krów i
            innych mieszkańców rancza. Możliwość karmienia i głaskania zwierząt.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <img
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-sm font-normal text-stone-300 md:text-base">
            Czas na wybrane aktywności - jazda konna, nordic walking, wycieczki
            rowerowe lub relaks w otoczeniu natury.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <img
    ...
    },
    {
      ...
      content: (
        <div>
          <h4 className="text-2xl font-bold text-white mb-4">
            Warsztaty i Tradycje
          </h4>
          <p className="mb-8 text-sm font-normal text-stone-300 md:text-base">
            Udział w warsztatach serowarskich, poznanie tradycyjnych metod
            wytwarzania sera podhalańskiego i innych lokalnych produktów.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <img
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-sm font-normal text-stone-300 md:text-base">
            Dzień na odpoczynek, łowienie ryb w prywatnym stawie, spacery po
            okolicy i cieszenie się ciszą beskidzkich lasów.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <img
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-sm font-normal text-stone-300 md:text-base">
            Wspólne ognisko z pieczeniem kiełbasek, opowieściami o Beskidach i
            obserwowaniem gwiaździstego nieba z dala od miejskich świateł.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <img
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-sm font-normal text-stone-300 md:text-base">
            Pożegnanie z nowymi przyjaciółmi, zabierasz ze sobą domowy ser,
            niezapomniane wspomnienia i zaproszenie na kolejny pobyt.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <img
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="mt-4 mb-6 text-4xl md:text-5xl font-bold text-white">
            7 Dni w Sielskiej Ostoi
          </h2>
          <p className="text-stone-300 text-lg max-w-2xl mx-auto">
            Od przyjazdu po niezapomniane wspomnienia - tak wygląda typowy pobyt
            w naszym ranczu.
          </p>
        </div>
      </div>
