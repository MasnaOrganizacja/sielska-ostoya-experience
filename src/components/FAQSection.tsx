		...
		questions: [
			{
				...
				a: 'Stare Miasto - 90km (1h 20min), Przemysłowe - 60km (50min), Górskie - 80km (1h 30min). Dokładną mapę otrzymujecie po rezerwacji.',
			},
			{
				q: 'Czy jest parking?',
			...
			},
			{
				...
				a: 'Najbliższa stacja PKP to Kolejowa Wieś (15km). Oferujemy odbiór z dworca za dodatkową opłatą 50zł.',
			},
		],
	},
	{
			...
			<div className="container mx-auto px-6 max-w-4xl">
				<div className="text-center mb-16">
					...
					<p className="text-muted-foreground text-lg">
						Nie znalazłeś odpowiedzi? Napisz do nas: kontakt@sielskaostoja.pl lub zadzwoń: +48 123 456 789
					</p>
				</div>
